...
const ShadowBox = ({x, y, blur, spread, color, radius, height, width}) => {
  return (
    <div className='shadow__box'>
      <div className='shadow__div' style={{ boxShadow: `${x}px ${y}px ${blur}px ${spread}px ${color}`, borderRadius:`${radius}px`, height:`${height}vh`, width:`${width}vw`}} >
